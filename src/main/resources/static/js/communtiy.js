        ...
        success: function (response) {
            if (response.code == 200) {
                ...
                if (response.code == 2003) {
                    ...
                    if (isAccepted) {
                        window.open("https://github.com/login/oauth/authorize?client_id=edcf01497196ffdf1467&redirect_uri=http://localhost:8080/callback&scope=user&state=1");
...
function collapseComments(e) {//e的值是整个标签的代码
        ...
        $.getJSON("/comment/" + id, function (data) {
            $.each(data.data.reverse(), function (index, comment) {
                ...
                var mediaBodyElement = $("<div/>", {
                    ...
                    "class": "pull-right",
                    "html":comment.comment.createTime
                })));
